...
\begin{align}
    V_\text{Kopf}&=V_\text{ges}-V_\text{diff} \\
        &= \frac{1}{3} (\symup{\pi} R_\text{o}^2) (\tan (\arctan (\frac{h}{R_\text{o}-R_\text{u}})) R_\text{o} ) 
            -\frac{1}{3} (\symup{\pi} R_\text{u}^2) (\tan (\arctan (\frac{h}{R_\text{o}-R_\text{u}})) R_\text{o}-h) \\
        &= \frac{1}{3} \symup{\pi} R_\text{o}^2 (\frac{h}{R_\text{o}-R_\text{u}}R_\text{o}) - \frac{1}{3}(\frac{hR_\text{o}}{R_\text{o}-R_\text{u}}-h)\symup{\pi}R_\text{u}^2 \\
        &= \SI{43.1}{\centi\meter\tothe{3}}
\end{align}
